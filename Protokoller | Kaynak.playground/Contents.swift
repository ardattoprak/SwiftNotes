...
let currentEmployee = Employee(firstName: "Arda", lastName: "Toprak", jobTitle: "Tech Avangelist", phoneNumber: "")

// Üstüne tıklanarak seçilen kişi
let selectedEmployee = Employee(firstName: "Emre", lastName: "Meydan", jobTitle: "Content Director", phoneNumber: "")
...
let bestEmployee = Employee3(firstName: "Burak", lastName: "Yılmaz", jobTitle: "Front Desk", phoneNumber: "")
